...
public class Server implements ActionListener {
    ...
    static java.util.List<ClientHandlerSocket> clients = new java.util.ArrayList<>();
...
// FIX: Add layout + vertical container at startup
...
// Then create scrollpane
        ...
        ServerRoundedPanel search = new ServerRoundedPanel(8);
    ...
    public void sendMessage() {
        ...
        // It broadcast the message to all clients
        broadcastToAll("Prince: " + msg);

        // It shows the message on frame on sender side
...
//        contactsPanel.add(Box.createVerticalStrut(5));
    ...
    public static JPanel formatLabel(String out) {
        // Force break long continuous text
//        out = out.replaceAll("(.{30})", "$1\u200B");
        ...
        ServerRoundedPanel bubble = new ServerRoundedPanel(40);
...
//        bubble.setBackground(new Color(16, 90, 156));
    ...
    static void broadcastToAll(String msg) {
        for (ClientHandlerSocket c : clients) {
            c.send(msg);
        }
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        while (true) {
            ...
            clients.add(new ClientHandlerSocket(clientOut));
                    ...
                    while ((msg = in.readLine()) != null){
                        ...
                        SwingUtilities.invokeLater(() -> {
                            ...
                            msgScroll.getVerticalScrollBar().setValue(
                                    msgScroll.getVerticalScrollBar().getMaximum()
                            );
                        });
...
class ClientHandlerSocket {
    ...
    ClientHandlerSocket(PrintWriter out) {
        this.out = out;
    }
...
class ServerRoundedPanel extends JPanel {

    private int radius;

    public ServerRoundedPanel(int radius) {
        this.radius = radius;
        setOpaque(false);
    }
